...
def create_fundamentals_analyst(llm):
    def fundamentals_analyst_node(state):
        ...
        if state.get("fundamentals_report"):
            print("CACHE: Skipping Fundamentals Analyst - report already loaded from cache")
            cached_msg = AIMessage(content="[Fundamentals report loaded from cache]")
            return {"messages": [cached_msg], "fundamentals_report": state["fundamentals_report"]}
        ...
        system_message = (
            f"You are a researcher tasked with analyzing fundamental information over {period_desc} about a company. "
