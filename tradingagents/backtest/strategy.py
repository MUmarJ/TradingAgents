...
from .execution import Order, OrderSide, OrderStatus
...
class PositionSizer:
    ...
    def __init__(
        self, method: str = "equal_weight", params: Optional[Dict[str, Any]] = None
    ):
        """
    ...
    def calculate_position_size(
        ...
        if self.method == "equal_weight":
            ...
            return self._confidence_weighted(
                signal, portfolio_value, current_price, max_position_size
            )
    ...
    def _confidence_weighted(
        ...
        if max_position_size:
            weighted_allocation = min(
                weighted_allocation, portfolio_value * max_position_size
            )
